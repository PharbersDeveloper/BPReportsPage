...
import layout from '../templates/components/bp-product-card-tag';
import { computed } from '@ember/object';
export default Component.extend({
    layout,
    tagName: "span",
    classNames: ["bp-product-card-tag", "product-card-tag"],
    content: 'default',
    attributeBindings: [''],
    index: 2,
    type: 'default', subtle: true,
    show: computed('index', function () { return this.get('index') < 3 }), tagContent: computed('index', function () { return 'TOP ' + (this.get('index') + 1) }),
